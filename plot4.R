...
GlobReactPower <- as.numeric(NewData$Global_reactive_power)

  # Create the sequence in which the four digrams are displayed
par(mfcol = c(2,2))
...
plot(DateTime,Voltage, type = "l",xlab = "datetime", ylab = "Voltage")
  ...
  # Diagram 4
plot(DateTime,GlobReactPower, type = "l",xlab = "datetime", ylab = "Global_reactive_power")
